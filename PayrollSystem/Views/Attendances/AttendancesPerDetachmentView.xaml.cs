...
namespace PayrollSystem.Views.Attendances
{
    ...
    /// </summary>
    public partial class AttendancesPerDetachmentView
    {
        private Detachment _detachment;
        private readonly PreferenceViewModel _preference;

        public AttendancesPerDetachmentView(Detachment detachment)
        {
            InitializeComponent();
        ...
        public void Add()
        {
            ...
            var view = new AttendanceView(payroll, _detachment);
            if (view.ShowDialog() == true)
            {
                Refresh();
            }
